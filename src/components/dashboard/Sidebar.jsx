        ...
        <aside className="w-64 bg-white dark:bg-[#1a2c2c] border-r border-gray-200 dark:border-[#2d3f3f] flex-shrink-0 hidden md:flex flex-col h-screen">
            ...
            <div className="flex-1 overflow-y-auto py-6 px-4 flex flex-col gap-6">
                ...
                <div className="flex items-center gap-3 px-2">
                    <div className="h-10 w-10 rounded-full bg-gray-200 dark:bg-gray-700 bg-cover bg-center" style={{ backgroundImage: patientInfo.profileImage }}></div>
                    <div className="flex flex-col">
                        <span className="text-sm font-semibold text-slate-900 dark:text-white">{patientInfo.fullName}</span>
                        <span className="text-xs text-[#618989] dark:text-slate-400">Patient ID: {patientInfo.patientId}</span>
                    </div>
                </div>
                ...
                <div className="mt-auto">
                    ...
                    <Link className={location.pathname === '/account-settings' ? activeLinkClass : inactiveLinkClass} to="/account-settings">
                        <span className="material-symbols-outlined">settings</span>
                        <span>Account</span>
                    </Link>
                    <Link className={location.pathname === '/help-support' ? activeLinkClass : inactiveLinkClass} to="/help-support">
